...
### [IM]MUTABLE /opt
## Some bootable images, like Fedora, have /opt symlinked to /var/opt, in order
## to make it mutable/writable for users. However, some packages write files to
## this directory, thus its contents might be wiped out when bootc deploys an
## image, making it troublesome for some packages. Eg, google-chrome, docker-
## desktop.
##
